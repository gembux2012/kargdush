...
$(document).ready(function() {
			...
			var fileReader = new FileReader();
				...
				fileReader.onload = (function(file) {
					...
					return function(e) {
						...
						dataArray.push({name : file.name, value : this.result,id : $('#id').val(), path:$('#path').val(),class:$('#class').val() });
	...
	$('#upload-button .upload').click(function() {
		...
		$.each(dataArray, function(index, file) {	
			...
			$.post('/Componentst/Upload/AploadImg/', dataArray[index], function(data) {
